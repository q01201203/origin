...
<div class="J_content">
    <div class="mt20 plr20">
        <form action="${ctx }/appValidcode/list" id="queryForm">
            ...
            <div class="J_table mt20">
                <div class="t_table">
                    <table>
                        ...
                        <tbody>
                        <c:choose>
                            <c:when test="${(appValidcodes)!= null && fn:length(appValidcodes) > 0}">
                                <c:forEach items="${appValidcodes }" var="r">
                                    <tr>
                                        <td class="first">
                                            <div class="t_text tc">
                                                ${r.id }
...
<script type="text/javascript">
    function myEdit(id){
        ...
        $.post('${ctx}/appValidcode/dialog/appValidcode_edit?id='+id, {}, function(str){
    ...
    function deleteById(id){
        ...
        layer.confirm(content, function(index){
            ...
            var loadIdx = layer.load();
            $.ajax({
                url : '${ctx}/appValidcode/ajax/delete',
                type : 'post',
                data : {
                    'id' : id
                },

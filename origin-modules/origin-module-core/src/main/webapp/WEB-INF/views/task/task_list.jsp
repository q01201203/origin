...
<div class="J_content">
    <div class="mt20 plr20">
        <form action="${ctx }/task/list" id="queryForm">
            ...
            <div class="J_table mt20">
                <div class="t_table">
                    <table>
                        ...
                        <tbody>
                        <c:choose>
                            <c:when test="${(tasks)!= null && fn:length(tasks) > 0}">
...
<script type="text/javascript">
    function myEdit(id){
        ...
        $.post('${ctx}/task/dialog/task_edit?id='+id, {}, function(str){

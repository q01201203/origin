...
public abstract class BaseFrame extends JFrame {
	...
	private JLabel imodelLabel = null;
	protected JTextField imodelText = null;

	private JLabel modelPdoLabel = null;
	protected JTextField modelPdoText = null;
	//private JLabel extendsLabel = null;
	//protected JComboBox<?> extendsBox = null;
	private JLabel idaoLabel = null;
	protected JTextField idaoText =null;
...
//	protected JCheckBox adminCheckBox = null;
	...
	private void init() {
		...
		this.panel1.setBounds(5, 80, 660, 450);
		...
		this.moduleLabel.setText("数据模块名称");
		this.moduleLabel.setToolTipText("数据模块名称");
		this.moduleLabel.setBounds(new Rectangle(35, 50, 100, 20));
		this.moduleText = new JTextField();
		this.moduleText.setText(config.getDataModuleName());
		...
		this.modelText.setBounds(new Rectangle(120, 80, 500, 20));

		this.imodelLabel = new JLabel();
		this.imodelLabel.setText("IModel");
		this.imodelLabel.setToolTipText("IModel");
		this.imodelLabel.setBounds(new Rectangle(35, 110, 100, 20));
		this.imodelText = new JTextField();
		this.imodelText.setBounds(new Rectangle(120, 110, 500, 20));

		this.modelPdoLabel = new JLabel();
		this.modelPdoLabel.setText("ModelDTO");
		this.modelPdoLabel.setToolTipText("ModelDTO");
		this.modelPdoLabel.setBounds(new Rectangle(35, 140, 100, 20));
		this.modelPdoText = new JTextField();
		this.modelPdoText.setBounds(new Rectangle(120, 140, 500, 20));
...
//		this.extendsBox.setBounds(new Rectangle(470, 80, 150, 20));
		...
		this.controllerLabel.setBounds(new Rectangle(35, 170, 100, 20));
		this.controllerText = new JTextField();
		this.controllerText.setBounds(new Rectangle(120, 170, 500, 20));

		this.serviceLabel = new JLabel();
		this.serviceLabel.setText("service");
		this.serviceLabel.setToolTipText("service");
		this.serviceLabel.setBounds(new Rectangle(35, 200, 100, 20));
		this.serviceText = new JTextField();
		this.serviceText.setBounds(new Rectangle(120, 200, 500, 20));
		...
		this.serviceImplLabel.setBounds(new Rectangle(35, 230, 100, 20));
		this.ServiceImplText = new JTextField();
		this.ServiceImplText.setBounds(new Rectangle(120, 230, 500, 20));

		this.idaoLabel=new JLabel();
		this.idaoLabel.setText("IDao");
		this.idaoLabel.setToolTipText("idao");
		this.idaoLabel.setBounds(new Rectangle(35, 260, 100, 20));
		this.idaoText = new JTextField();
		this.idaoText.setBounds(new Rectangle(120, 260, 500, 20));

		this.daoLabel = new JLabel();
		this.daoLabel.setText("Dao");
		this.daoLabel.setToolTipText("dao");
		this.daoLabel.setBounds(new Rectangle(35, 290, 100, 20));
		this.daoText = new JTextField();
		this.daoText.setBounds(new Rectangle(120, 290, 500, 20));

		this.modelXmlLabel = new JLabel();
		this.modelXmlLabel.setText("ModelXml");
		this.modelXmlLabel.setToolTipText("ModelXml");
		this.modelXmlLabel.setBounds(new Rectangle(35, 320, 100, 20));
		this.modelXmlText = new JTextField();
		this.modelXmlText.setBounds(new Rectangle(120, 320, 500, 20));
		
//		this.adminCheckBox = new JCheckBox("后台管理页");
//		this.adminCheckBox.setBounds(new Rectangle(120, 350, 500, 20));
...
//        });
		...
		this.listLabel.setBounds(new Rectangle(35, 350, 100, 20));
		this.listText = new JTextField();
		this.listText.setBounds(new Rectangle(120, 350, 500, 20));

		this.editLabel = new JLabel();
		this.editLabel.setText("编辑页(JSP)");
		this.editLabel.setToolTipText("编辑页");
		this.editLabel.setBounds(new Rectangle(35, 380, 100, 20));
		this.editText = new JTextField();
		this.editText.setBounds(new Rectangle(120, 380, 500, 20));
		...
		this.generateButton.setBounds(new Rectangle(280, 410, 80, 25));
		...
		this.panel1.add(this.imodelLabel);
		this.panel1.add(this.imodelText);
		this.panel1.add(this.modelPdoLabel);
		this.panel1.add(this.modelPdoText);
...
//		this.panel1.add(this.extendsBox);
		...
		this.panel1.add(this.idaoLabel);
		this.panel1.add(this.idaoText);

...
public class ExcelUtils {
	...
	public static <T> void exportXlsxByBean(HttpServletResponse response, String fileName, 
			Map<String, String> headNameMap, List<T> list) throws IOException{
	...
	public static void exportXlsx(HttpServletResponse response, String fileName, 
			Map<String, String> headNameMap, List<Map<String, Object>> dataList) throws IOException{
	 ...
	 * @throws IOException 
	 */
	public static Workbook exportXlsx(String sheetName, Map<String, String> headNameMap, List<Map<String, Object>> dataList) throws IOException{
	...
	private static void setCellValue(Cell cell, Object obj) throws IOException{
		if(obj == null){
			...
			BufferedImage bufferImg = (BufferedImage) obj;
			int height = bufferImg.getHeight();
			int width = bufferImg.getWidth();
			cell.getRow().setHeightInPoints(height);
			cell.getSheet().setColumnWidth(cell.getColumnIndex(), width*40);
			ByteArrayOutputStream byteArrayOut = new ByteArrayOutputStream();
			ImageIO.write(bufferImg, "jpg", byteArrayOut);
			Drawing patriarch = cell.getSheet().createDrawingPatriarch();
			XSSFClientAnchor anchor = new XSSFClientAnchor(0, 0, width, height,(short) cell.getColumnIndex(), cell.getRowIndex(), (short) (cell.getColumnIndex()+1), cell.getRowIndex()+1);     
            anchor.setAnchorType(3);
            patriarch.createPicture(anchor, cell.getSheet().getWorkbook().addPicture(byteArrayOut.toByteArray(), XSSFWorkbook.PICTURE_TYPE_JPEG));
		}else{
